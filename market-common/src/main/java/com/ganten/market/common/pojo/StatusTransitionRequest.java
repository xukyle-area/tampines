...
public class StatusTransitionRequest {
    ...
    private String status; // common.MatchingEngineStatus
    ...
    public static class Builder {
        private final StatusTransitionRequest r = new StatusTransitionRequest();
        ...
        public StatusTransitionRequest build() {
            return r;
        }
    }
}
